...
根据前面计算的年龄和其他特征的相关性，发现Age和Pclass, SibSp, Parch相关系数较高，因此利用这三个特征和随机森林模型，对年龄的缺失值进行预测。
...
![1701851906887](image/实验报告/1701851906887.png)

可以看到，使用随机森林模型填充Age确实值可以一定程度上提升knn，dt，rf，voting模型的准确率，对其他模型的影响较小
